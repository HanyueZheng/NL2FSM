...
#         lines = f.readlines()
#         for line in lines:
#             input_ids = torch.tensor([tokenizer.encode(line, add_special_tokens=True)])  # Add special tokens takes care of adding [CLS], [SEP], <s>... tokens in the right way for each model.
#             print(line)
#             with torch.no_grad():
